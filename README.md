...
The physics of the rocket flight and the simulation technique are expalined here: https://github.com/Mario-Borilov-physics/Rocket-Launch-Simulator/blob/main/The_Physics_Behind_a_Rocket_Launch_Simulator%20(1).pdf
# Features
